...
from app.models.resource_segment import get_segments_by_role, get_all_resource_segments, get_resource_segment_by_id
...
async def get_available_segments():
    ...
    try:
        ...
        accessible_segments.sort(key=lambda s: (s['securityLevel'], s['name']))
...
@require_auth
async def get_segment_details(segment_id):
    """

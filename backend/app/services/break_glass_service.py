...
class BreakGlassService:
    ...
    async def process_approval(self, request_id: str, approver_id: str, decision: str, 
        ...
        try:
            ...
            # Check if we have enough approvals (exactly 2 different administrators)
            ...
            if approved_count >= 2 and len(unique_approvers) >= 2:
                ...
                remaining_approvals = 2 - approved_count
                return {
                    'success': True,
    ...
    async def _schedule_approval_timeout(self, request_id: str):
        """Schedule approval timeout check"""
        # In a real implementation, you would use a task queue or scheduler
